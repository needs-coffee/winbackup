...
class TestValidArchive(unittest.TestCase):
    ...
    def test_backup_folder(self):
        ...
        response = self.archiver.backup_folder(filename, 
                                             self.testdir_path,
                                             self.temp_path,
                                             password='', quiet=True)
    ...
    def test_backup_plex_folder(self):
        ...
        response = self.archiver.backup_plex_folder(filename, 
                                             self.testdir_path,
                                             self.temp_path,
                                             password='', quiet=True)
...
class TestReturnType(unittest.TestCase):
    ...
    def test_backup_folder_returns_tuple(self):
        response = self.archiver.backup_folder('test_backup_return.7z', 
                                             self.testdir_path,
                                             self.temp_path,
                                             password='', quiet=True)
    ...
    def test_backup_plex_folder_returns_tuple(self):
        response = self.archiver.backup_plex_folder('test_backup_plex_return.7z', 
                                             self.testdir_path,
                                             self.temp_path,
                                             password='', quiet=True)
        self.assertTrue(type(response) == tuple)
